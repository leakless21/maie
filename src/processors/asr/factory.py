...
class ASRProcessorFactory:
    ...
    def create(cls, backend_type: str, **kwargs) -> ASRBackend:
        ...
        if backend_type not in cls.BACKENDS:
            ...
            raise ValueError(f"Unknown ASR backend type: {backend_type}. "
    ...
    @classmethod
    def create_with_audio_processing(cls, backend_type: str, **kwargs) -> Dict[str, Any]:
        """
...
ASRProcessorFactory.register_backend("whisper", WhisperBackend)
ASRProcessorFactory.register_backend("chunkformer", ChunkFormerBackend)