...
def log_config_change(config_key: str, old_value: Any, new_value: Any, user: Optional[str] = None) -> None:
...
def log_security_event(event_type: str, severity: str, context: ErrorContext, **kwargs) -> None:
