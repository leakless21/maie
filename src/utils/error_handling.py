...
async def safe_async_execute(func: AsyncSafeCallable, *args, **kwargs) -> ExecutionResult:
...
def handle_generic_error(error: Exception, request_id: Optional[str] = None) -> Dict[str, Any]:
...
def format_error_details(error: Exception, context: Optional[ErrorContext] = None) -> Dict[str, Any]:
...
def log_exception_safely(logger_func: Callable, error: Exception, message: str = "Exception occurred"):
