...
class TestSafeParseJson:
    ...
    def test_safe_parse_json_with_context(self):
        ...
        data, error = safe_parse_json('invalid json', error_context={"template_id": "test"})
        assert data is None
...
class TestValidateJsonSchema:
    ...
    def test_validate_json_schema_with_context(self):
        ...
        schema = {"type": "object", "properties": {"name": {"type": "string"}}}
        data = {"name": 123}
        is_valid, error_details = validate_json_schema(data, schema, error_context={"user_id": "123"})
        assert is_valid is False
...
class TestCreateValidationSummary:
    ...
    def test_create_validation_summary_success(self):
        ...
        summary = create_validation_summary('{"key": "value"}', {}, {"key": "value"}, None)
    ...
    def test_create_validation_summary_failure(self):
        ...
        summary = create_validation_summary('{"key": "value"}', {}, {"key": "value"}, "Some error")
