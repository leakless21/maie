...
class TestValidateChoice:
    ...
    def test_validate_choice_invalid(self):
        ...
        with pytest.raises(ValueError, match="protocol must be one of \\['http', 'https'\\], got 'ftp'"):
...
class TestValidateListLength:
    ...
    def test_validate_list_length_valid(self):
        ...
        result = validate_list_length([1, 2, 3], min_length=2, max_length=5, field_name="test")
        assert result == [1, 2, 3]
